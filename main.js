...
const gcrevoke = ["6283896811444-1621430788@g.us"]
prefix = '#'
shp = '⬡'
owner = "6283896811444@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
console.log(color(`      CREADOR BOSS OFC` ,'red'))
console.log(color(``, 'cyan'))
console.log(color(`   [•]`, 'red'), color(`Servidor    : ${ucapanWaktu}`, 'red'))
console.log(color(`   [•]`, 'red'), color(`Bot Version : 2.1.2`, 'red'))
console.log(color(`   [•]`, 'red'), color(`Estado      : Activo`, 'red'))
console.log(color(`   [•]`, 'red'), color(`Dueño       : ${fakeyoi}`, 'red'))
console.log(color(``, 'cyan'))
console.log(color(figlet.textSync('', {
font: 'Standard',
horizontalLayout: 'default',
...
whitespaceBreak: false
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`6283896811444@s.whatsapp.net`, `「 *NUEVO USUARIO* 」\n\n _Bot Conectado_`, MessageType.extendedText)
...
await client.connect({ timeoutMs: 30 * 1000 });
  fs.writeFileSync("./session.json",JSON.stringify(client.base64EncodedAuthInfo(), null, "\t"));    
    client.on('connecting', () => {
		console.log(color('ON'), color('Conectando...', 'cyan'))
		})
	
	client.on('open', () => {
	console.log(color('ON'), color('Conectado', 'green'))
	}) 
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                goodbyeBut = [{buttonId:`attp Adiós rata de mierda`,buttonText:{displayText:'BYE'},type:1}, {buttonId:`menu`,buttonText:{displayText:'MENU'}, type:1}]
