...
whitespaceBreak: false
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`5493814668151@s.whatsapp.net`, `「 *NUEVO USUARIO* 」\n\n _Bot Conectado_`, MessageType.extendedText)
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 console.log(color('|NOTA|', 'white'), color('Cuidado con tu información personal', 'magenta'))
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                goodbyeBut = [{buttonId:`attp adiós gay`,buttonText:{displayText:'BYE'},type:1}, {buttonId:`listonline`,buttonText:{displayText:'ONLINE'}, type:1}]
