...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                welcomeBut = [{buttonId:`waifu`,buttonText:{displayText:'𝙽𝙴𝚆 •ც૦੮'},type:1}]
                ...
                out = `*Gᴏᴏᴅ Bʏᴇ* 👋🏻\n@${num.split('@')[0]}\nMateo había disfrutado de haber pasado tiempo con sus queridos amigos. Pero era ya tarde, y debía partir. Así que se levantó, les miró, extendió la mano, y pronunció aquellas palabras que siempre hacían sonreir a su más allegado compañero:\n“¡Hasta luego, Lucas!”\n\n𝙽𝙴𝚆 •ც૦੮`
      ...
      if (anu.action == "demote") {
        ...
        teks = `${anu_user} Gracias por tu servidor 😔🥀`;
        client.sendMessage(mdata.id, buffer, MessageType.image, {
          caption: teks,
        });
      }
