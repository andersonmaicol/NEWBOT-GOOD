...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6283896811444@s.whatsapp.net`]
...
/*const reply = (teks) => {
			cnf.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6283896811444?text=ola%20UwU`}}})
		}*/
...
const finv = {
    ...
    const fvn = {
      key: {
        participant: `6283896811444@s.whatsapp.net`,
...
const fvid = {
	 key: { 
          fromMe: false,
	      participant: `6283896811444@s.whatsapp.net`, ...(from ? 
	 { remoteJid: "6289643739077-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
...
const fakewa = (teks) => {        
cnf.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `NewBot`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6283896811444?text=hola%20boss`}}})
		}
...
"externalAdReply": {
                "title": `WhatsApp`,
                "body": `wa.me/6283896811444`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6283896811444`,
                "thumbnailUrl": "https://i.ibb.co/R6jkZmH/fg1.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6283896811444`,
...
groups = cnf.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6283896811444@s.whatsapp.net"
        dtod = '6283896811444'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
${readmore}
`
sendButLocation(from, `${y}`,`Creador : Boss ofc`, {jpegThumbnail:iye}, [{buttonId:`owner`,buttonText:{displayText:'OWNER'},type:1},{buttonId:`banchat`,buttonText:{displayText:'MUTE GP'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
...
case 'crefdos':
 ...
 🔥 : wa.me/${dtod.split('@')[0]}
 `
     credit = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 1000, "message": `${yez}`, "footerText": "By Boss", "thumbnail": iye, "surface": 'CATALOG'}}, {quoted: mek})
...
cnf.sendMessage(from, ini_buf, image, { quoted: mek, thumbnail: fs.readFileSync('./cnf.jpg')})
		...
		case 'comandos':
                ...
                if (args.length < 1) return fakegroup(`#comandos 1`)
                dpuhy = args.join(' ')
               tiyo = `╭╼╼❏   *𝐎𝐖𝐍𝐄𝐑*
┋ *❀્᭄᭳͜͡* 🥀 ${prefix}𝙾𝙽
┋ *❀્᭄᭳͜͡* 🥀 ${prefix}𝙾𝙵𝙵
